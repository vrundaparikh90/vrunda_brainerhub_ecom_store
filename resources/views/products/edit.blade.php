            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="add-cat-form" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{route('products_update',$productData->id)}}">
                      {{ csrf_field() }}
                      ...
                      @if(count($categoryArray) > 0)
                          @foreach($categoryArray as $k1 => $v1)
                          <div class="form-group" id="parent_cat_id{{$k1}}">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Parent Category
                            </label>
                            <div class="col-md-4 col-sm-4 col-xs-12">
                              <select id="parent_id{{$k1}}" name="parent_id{{$k1}}" class="form-control parent_id" multiple>
                              @if(count($v1) > 0)
                                @foreach($v1 as $k => $v)
                                  <option value="{{$v->id}}" <?php if(in_array($v->id , $productData->category_ids)) echo 'selected'; ?>>{{$v->name}}</option>
                                @endforeach
                              @endif
                              </select>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="name" name="name"  class="form-control col-md-7 col-xs-12" value="{{old('name',$productData->name)}}">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea class="form-control" id="description" name="description">{{old('description',$productData->description)}}</textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="quantity" name="quantity"  class="form-control col-md-7 col-xs-12" value="{{old('quantity',$productData->quantity)}}" min="1" step="1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="number" id="price" name="price" class="form-control col-md-7 col-xs-12" value="{{old('price',$productData->price)}}" min="1" step=".01">
